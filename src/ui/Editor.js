...
import './Editor.css';
const CodeEditor = ({ code, onChange, language = 'python', theme = 'futuristic' }) => {
    ...
    const editorTheme = theme === 'neon-circuit' || theme === 'futuristic' || theme === 'neon'
        ...
        : theme === 'leetcode-dark'
            ? 'leetcode-dark'
            : 'neon-circuit';
    return (_jsx("div", { ref: containerRef, className: "monaco-editor-container", children: _jsx(Editor, { height: editorHeight, language: monacoLanguage, value: code, onChange: handleEditorChange, onMount: handleEditorDidMount, theme: editorTheme, options: {
